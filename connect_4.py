...
#---------------------------------------------------------------------- INTRO SEQUENCE ----------------------------------------------------------
intro_songs.play_song('audio/intro_part_1.mp3')
...
while cutscene < 3 and menu == True:
   ...
   if cutscene < 1:
      i_1 = fade_in((0, 0, 0), screen, 560, 600, 5, [('text', (font_1, 'POWERED', screen, (255, 255, 255), (200, 200))), 
                                                   ('text', (font_1, 'BY', screen, (255, 255, 255), (250, 260))),
                                                   ('text', (font_1, 'PYGAME', screen, (255, 255, 255), (205, 320)))])

      i = fade_out((0, 0, 0), screen, 560, 600, 5, [('text', (font_1, 'POWERED', screen, (255, 255, 255), (200, 200))), 
                                                    ('text', (font_1, 'BY', screen, (255, 255, 255), (250, 260))),
                                                    ('text', (font_1, 'PYGAME', screen, (255, 255, 255), (205, 320)))])
      cutscene = 1

   if cutscene < 2:
      i_2 = fade_in((0, 0, 0), screen, 560, 600, 5, [('image', (all_images['half_oreo'], screen, (110, 60), (330, 350))),
                                                   ('text', (font_1, 'Production', screen, (255, 255, 255), (190, 400)))])

      i_3 = fade_out((0, 0, 0), screen, 560, 600, 5, [('image', (all_images['half_oreo'], screen, (110, 60), (330, 350))),
                                                    ('text', (font_1, 'Production', screen, (255, 255, 255), (190, 400)))])
      cutscene = 2

   if cutscene < 3:
      i_4 = fade_out((255, 255, 255), screen, 560, 600, 8)
      break

   pygame.display.update()

#--Did The play skip any fade ins?--
if i > 0 or i_2 > 0 or i_3 > 0 or i_4 > 0:
   intro_songs.play_song('audio/intro_part_2.mp3')
#-------------------------------------------------------------------
...
#--The first chip--
chip = Chip(0, 1, (255, 255, 0), 0, 0, 80, 80, 1, all_images['chip'], False)
#-------
...
while game_on:
   ...
   if chip.is_falling is True:
      ...
      if fall is 1 and current_player is 1:
         chip = Chip(i, current_player + 1, (255, 0, 0), mx, 0, 80, 80, 1, image=all_images['chip'], is_falling=False)
         chip.move(mx)
         i += 1
         current_player = 2

      elif fall is 1 and current_player is 2:
         chip = Chip(i, current_player - 1, (255, 255, 0), mx, 0, 80, 80, 1, image=all_images['chip'], is_falling=False)
         chip.move(mx)
         i += 1
         current_player = 1
